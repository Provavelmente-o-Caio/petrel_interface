...
namespace dlseis_well_tie_petrel
{
    public class Plugin : Slb.Ocean.Core.Plugin
    {
        ...
        {
            get { return "Plugin based on the implementation by Valentin Tschannen: https://github.com/dlseis/dlseis_well_tie."; }
        }
        ...
        public override IEnumerable<ModuleReference> Modules
        {
            get 
            {
                yield return new ModuleReference(typeof(dlseis_well_tie_petrel.Module)); 
